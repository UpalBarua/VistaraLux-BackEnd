...
export const getPieCharts = async (
  ...
  try {
    ...
    return next(
      new ErrorHandler("Failed to getting admin dashboard's pie charts", 400),
    );
  }
};
...
export const getBarCharts = async (
  ...
  try {
    ...
    const [lastSixMonthUsers, lastSixMonthProducts, lastTwelveMonthOrders] =
      await Promise.all([
    ...
    return next(
      new ErrorHandler("Failed to getting admin dashboard's bar charts", 400),
    );
  }
};
...
export const getLineCharts = async (
  ...
  try {
    ...
    return next(
      new ErrorHandler("Failed to getting admin dashboard's line charts", 400),
    );
  }
};
