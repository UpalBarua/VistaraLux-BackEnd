...
export const getLatestProducts = async (
  ...
  try {
    ...
    return next(
      new ErrorHandler("An error occurred during getting latest products", 400),
    );
  }
};
...
export const getAllCategories = async (
  ...
  try {
    ...
    return next(
      new ErrorHandler("An error occurred during getting all categories", 400),
    );
  }
};
...
export const getAdminProducts = async (
  ...
  try {
    ...
    return next(
      new ErrorHandler("An error occurred during getting all products", 400),
    );
  }
};
...
export const getSingleProduct = async (
  ...
  try {
    ...
    return next(
      new ErrorHandler(
        "An error occurred during getting a single product",
        400,
      ),
    );
  }
